...
to as the ``counterfactual'' framework (\citeproc{ref-hernan2023}{Hernan
and Robins 2023})).
...
(\citeproc{ref-neyman1923}{Neyman 1923}). It was later developed by
Donald Rubin to address causal inference in non-experimental settings
(\citeproc{ref-rubin1976}{Rubin 1976}), and was extended by Jamie Robins
to address confounding time-varying confounding
(\citeproc{ref-robins1986}{Robins 1986}). A central focus of the
...
problem of causal inference'' (\citeproc{ref-holland1986}{Holland 1986};
...
psychological well-being (\citeproc{ref-nguyen2021green}{Nguyen \emph{et
al.} 2021}; \citeproc{ref-reyes2021linking}{Reyes-Riveros \emph{et al.}
2021}). For simplicity, we will refer to our outcome of interest as
