---
title: "The Causal Effects of Religious Identification on Multi-Dimensional Flourishing: Evidence from a Five Wave Panel Study In New Zealand"
abstract: |
...
title <- glue::glue("Causal Effects of Shift Interventions on {nice_exposure_name} on Multi-Dimensional Well-Being")
...
A central question in the scientific study of religion is whether religion fosters health [citations]. However, quantifying causal effects for religion presents significant challenges [@major2023exploring]. Investigators have limited scope to randomise supernatural beliefs, community worship, and personal prayer. On the other hand, valid causal inferences from non-experimental, "real world" data must combine high-resolution repeated-measures time-series data with robust methods for causal inference. Few studies meet this standard. 

Here, to obtain causal inferences from time-series data, we leverage comprehensive panel data from `r n_participants` participants in the New Zealand Attitudes and Values Study from 2018-2021 and quantify the effects of clearly defined interventions in reliousity across the population of New Zealanders assessed on XXX outcome domains of well-being. We obtain causal inferences by contrasting inferred population averages under different sequential treatment regimes [@haneuse2013estimation; @diaz2023lmtp; @díaz2021; @hoffman2023]. 
...
1. Continuous Secular Treatment (Secular): what would be the population average well-being if everyone started out secular at wave 1, and remained secular in wave 2 and 3?

2. Continuous Religious Treatment (Religious):  what would be the population average well-being if everyone started out highly religious at wave 1, and remained highly religious in wave 2 and 3?

3. Convert to Secularism (Done): what would be the population average well-being if everyone started out religious at wave 1, but became secular in wave 2 and 3?

4. Convert to Religious (Convert): what would be the population average well-being if everyone started out seci;ar at wave 1, but became highly religious in wave 2 and 3?


These questions simulates a hypothetical experiment with random assignment to regular or non-attendance, emulating the scientifically interesting all/none contrast that is common in experimental designs [@hernán2016].
...
As mentioned we define four causal intervention, yeilding six causal contrasts. 
