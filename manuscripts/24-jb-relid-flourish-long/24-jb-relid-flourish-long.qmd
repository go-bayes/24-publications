...
abstract: |
  **Question**: Does religious identificaton affect multi-dimensional well-being?  If so, which aspects of well-being, and by how much? 
...
A central question in the scientific study of religion is whether religion fosters health, and by how much [citations]. However, the question as stated, is unclear. For 
...
4. **Convert to Religious (Convert):** what would be the population average well-being if everyone started out secul;ar at time 1, but became highly religious in time 2 and 3?
...
To interpret our statistical models causally requires the following assumptions.
...
2.	Conditional Exchangability: conditional on observed covariates, treatment assignment is independent of the potential outcomes being compared (i.e. there is no unmeasured confounding) [@hernan2024WHATIF; @chatton2020].
