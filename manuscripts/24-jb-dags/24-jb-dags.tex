...
challenges (\citeproc{ref-westreich2010}{Westreich and Cole 2010}). For
...
which can be useful, refer to (\citeproc{ref-yola}{\textbf{yola?}}).
...
(\citeproc{ref-yola}{\textbf{yola?}}) for a worked example, revealing
...
confounding in more detail in (\citeproc{ref-yola}{\textbf{yola?}}).
...
(\citeproc{ref-richardson2023potential}{2023})). We consider
...
detail refer to (\citeproc{ref-yola}{\textbf{yola?}}))
...
\item
  ...
  is unwise because where assignment to treatment has not been
  randomised, we should almost always draw relations of unmeasured
  confounding on our causal graphs. Rejecting causal inferences in
...
\item
  ...
  to (\citeproc{ref-yola}{\textbf{yola?}}) for an overview.
\end{enumerate}
...
Refer to (\citeproc{ref-yola}{\textbf{yola?}}) for an overview.
...
(\citeproc{ref-yola}{\textbf{yola?}}) for use cases.
...
(`treatments') to be compared (\citeproc{ref-murray2021a}{Murray
\emph{et al.} 2021}; \citeproc{ref-shiba2023uncovering}{Shiba \emph{et
al.} 2023}).
...
Below is (\citeproc{ref-yola}{\textbf{yola?}}) formulation of Pearl
(\citeproc{ref-pearl2009a}{2009})'s mathmatical representation of a
structural causal model. I use (\citeproc{ref-yola}{\textbf{yola?}})'s
...
treatment policies (\citeproc{ref-yola}{\textbf{yola?}})
