...
plot_socializing_prosocial_loss_z + plot_socializing_prosocial



### SOCIALISING GAIN PREJUDICE
# ALERT: GRAPHS WARMTH SOCIALISING ----------------------------------------
tab_warm_socialising<- here_read("tab_warm_socialising")
...
### SOCIALISING GAIN HELP RECEIVED



### SOCIALISING LOSS HELP RECEIVED
...
plot_church_LOSS_prosocial <- margot_plot(
  ...
  subtitle = "Lose any service attendance",
  xlab = "",
  ylab = "",
  estimate_scale = 1,
  base_size = 8,
...
## loss church on prosocial behaviour
tab_compare_church_prosocial_behaviour_z_loss<- here_read("tab_compare_church_prosocial_behaviour_z_loss")
...
plot_church_prosocial_loss <- margot_plot(
  group_tab_compare_church_prosocial_behaviour_z_loss,
  type = "RD",
  title = "Religious service effect on reported donations and volunteering",
...
ggsave(
  ...
  height = 6,
  units = "in",
  filename = "plot_church_prosocial_loss.png",
  device = 'png',
  limitsize = FALSE,
  dpi = 600
)
...
plot_charity_church_z_loss <- margot_plot(
  group_tab_compare_church_prosocial_behaviour_z_loss,
  type = "RD",
  title = "Religious service effect on reported donations and volunteering",
  subtitle = "Lose any religious service",
...
ggsave(
  ...
  height = 6,
  units = "in",
  filename = "plot_charity_church_z_loss.png",
  device = 'png',
  limitsize = FALSE,
  dpi = 600
)
...
### Loss religious service on help received
# graph
...
group_tab_warm_socialising_loss<- here_read("group_tab_warm_socialising_loss")
plot_warm_socialising_loss <- margot_plot(
  group_tab_warm_warm_socialising_loss,
  type = "RD",
  title = "Socialing effect on prejudice/acceptance",
  subtitle = "Any socialising lost",
  xlab = "",
...
tab_contrast_socialising_on_donate_loss_raw<- here_read("tab_contrast_socialising_on_donate_loss_raw")
...
### LOSS SOCIALISING ON HELP RECEIVED
...
plot_socializing_prosocial_loss_z


ggsave(
  plot_behaviour_socialising_loss_z,
  path = here::here(here::here(push_mods, "figs")),
  width = 8,
  height = 6,
  units = "in",
...
### SOCIALISING LOSS HELP RECEIVED MODELS 
