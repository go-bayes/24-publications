...
\includegraphics{24_no_name_lmtp_coop_church_files/figure-pdf/fig-hist-1.pdf}
...
\includegraphics{24_no_name_lmtp_coop_church_files/figure-pdf/fig-1_1-1.pdf}
...
\includegraphics{24_no_name_lmtp_coop_church_files/figure-pdf/fig-study2-1.pdf}
...
1.091, with a lower bound of 1. At this lower bound, unmeasured
confounders would need a minimum association strength with both the
intervention sequence and outcome of 1 to negate the observed effect.
Weaker confounding would not overturn it. We infer \emph{that evidence
...
1.412, with a lower bound of 1. At this lower bound, unmeasured
confounders would need a minimum association strength with both the
intervention sequence and outcome of 1 to negate the observed effect.
Weaker confounding would not overturn it. We infer \emph{that evidence
for causality is not reliable}.
...
1.425, with a lower bound of 1. At this lower bound, unmeasured
confounders would need a minimum association strength with both the
intervention sequence and outcome of 1 to negate the observed effect.
Weaker confounding would not overturn it. We infer \emph{that evidence
for causality is not reliable}.
...
\includegraphics{24_no_name_lmtp_coop_church_files/figure-pdf/fig-study_3-1.pdf}
...
However, it is important to emphasise that these population-wide
estimates for aggregated one-year effects reflect short-term behavioural
changes and do not address the broader, longer-term implications of
gaining or losing religious institutions --- an issue we revisit in the
discussion.
...
does not capture the network structure of charitable giving.

However, we can gain insights into the role of religious charities by
examining other data sources. In New Zealand, religious organisations
operate as public charities, and their financial records are
transparent. Public data show that religious institutions account for
40\% of the charitable sector in New Zealand
(\citeproc{ref-McLeod2020}{McLeod 2020 p. 17}), with similar or even
higher proportions observed in other countries
...
and of course secular charities are not immune to the same issue.
...
Finally, the generalisability of our findings beyond New Zealand remains
to be investigated. Although our results apply to the New Zealand
population, further research is needed to determine whether these
findings hold in other cultural or national contexts. Initiatives such
as the Global Flourish Study (\citeproc{ref-johnson2022global}{Johnson
and VanderWeele 2022}), and others, will eventually provide
opportunities to apply causal methods across diverse cultures.
...
service attendance causally affects prosocial behaviours. Beyond the
...
underutilised in the discipline. Most psychological questions are
inherently causal. To understand the effects of interventions, something
beyond the associational methods that dominate observational psychology
is required (\citeproc{ref-bulbulia2024swigstime}{Bulbulia 2024d};
...
\includegraphics{24_no_name_lmtp_coop_church_files/figure-pdf/fig-match_1-1.pdf}
