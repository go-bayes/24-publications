...
Causal forest estimates the average treatment effect as `r ATE_fit_causal_forest`. This converges to to the true value supplied to the genearating mechanism of 0.3
