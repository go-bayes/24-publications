...
\hypersetup{
  pdftitle={Methods for Causal Inference Part 4: Confounding in Experiments},
...
\title{Methods for Causal Inference Part 4: Confounding in Experiments}
...
(\citeproc{ref-bulbulia2024wierd}{Bulbulia 2024b}). Describing the
special methods for estimating per-protocol effects with multiple
sequential treatments is beyond the scope of this commentary
...
Bulbulia, JosephA (2024a) Methods in causal inference part 2:
