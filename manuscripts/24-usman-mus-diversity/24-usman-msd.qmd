...
results_religion$plots$`Religious Identification Level`
results_religion$plots$`Spiritual Identification Level`
results_religion$plots$`Belief in God` + scale_y_continuous(limits = c(-0,1.1))
results_religion$plots$`Belief in Spirit`+ scale_y_continuous(limits = c(-0,1.1))

results_religion$plots$`Monthly Religious Service Attendance`+ scale_y_continuous(limits = c(0,35))
results_religion$plots$`Weekly Scripture`  + scale_y_continuous(limits = c(-.4,35))
results_religion$plots$`Weekly Prayer`  + scale_y_continuous(limits = c(-.4,30))

# access individual plots discrimination

results_discrim$plots$`Perceived Ethnic Discrimination`
results_discrim$plots$`Perceived Religious Discrimination`
results_discrim$plots$`Perceived Gender Discrimination`
results_discrim$plots$`Perceived Age Discrimination`

# access individual plots psychological wellbeing
results_life$plots$Gratitude
results_life$plots$`Life Satisfaction`
results_life$plots$`Meaning: Purpose`
results_life$plots$`Meaning: Sense`



# access individual plots life-reflective wellbeing
results_psych$plots$Anxiety+ scale_y_continuous(limits = c(-.5,5))
results_psych$plots$Depression + scale_y_continuous(limits = c(-.5,5))
results_psych$plots$Fatigue+ scale_y_continuous(limits = c(-.5,5))
results_psych$plots$Rumination+ scale_y_continuous(limits = c(-.5,5))

results_social$plots$`Belonging - Acceptance`
results_social$plots$`Belonging - Shared Beliefs`
results_social$plots$`Belonging - Outsider (Reversed)`
results_social$plots$`Neighbourhood Community`
results_social$plots$`Support - Help Availability`
results_social$plots$`Support - No Guidance (Reversed)`
results_social$plots$`Support - Someone to Turn To`
