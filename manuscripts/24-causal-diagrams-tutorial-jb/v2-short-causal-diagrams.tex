...
assumptions that must be justified (\citeproc{ref-edwards2015}{Edwards
\emph{et al.} 2015}; \citeproc{ref-robins1986}{Robins 1986};
...
\citeproc{ref-pearl2009}{2009a}). We begin with terminology.

\subsubsection{2.1 The meaning of our
symbols}\label{the-meaning-of-our-symbols}

The conventions that describe the meanings of our symbols are given in
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{\textbackslash{}terminologylocalconventions}
\end{Highlighting}
\end{Shaded}

}

\caption{\label{fig-conventions}Our variable naming conventions. This
figure is adapted from (\citeproc{ref-bulbulia2023}{Bulbulia 2023a})}
...
\(A\) denotes the ``treatment'' or ``exposure'' variable. This is the
variable for which we seek to understand the effect of intervening on
it. It is the ``cause;''

\(Y\) denotes the outcome or response of an intervention. It is the
``effect.'' Last week we considered whether marriage \(A\) causes
happiness \(Y\).
...
represented graphically (\citeproc{ref-pearl2009a}{Pearl 2009b}).
...
\includegraphics[width=1\textwidth,height=1\textheight]{terminologyelconfounders.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-common-cause-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-common-cause-solution-1.pdf}
...
\citeproc{ref-bulbulia2023e}{Bulbulia 2023b};
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-mediator-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-common-effect-solution-2-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-common-effect-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-common-effect-solution-3-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-descendant-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-descendant-solution-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-m-bias-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-m-bias-solution-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-descendant-proxy-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-descendant-solution-2-1.pdf}
...
\includegraphics[width=0.5\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-measure-error-1.pdf}
...
(\citeproc{ref-bulbulia2023e}{2023b}) for more discussion.)
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-interaction-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-interaction-solved-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-effect-modification-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-eff-mod-rel-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-effect-modification-4-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-effect-modification-5-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-effect-modification-5b-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-effect-modification-5c-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-experiment-selection-collider-adjustment-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-experiment-selection-restriction-adjustment-2-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-experiment-selection-restriction-adjustment-4-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-experiment-selection-collider-adjustment-measured-1.pdf}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-mediation-assumptions-1.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-9-1.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-time-vary-common-cause-A1-l1-1.pdf}
...
(\citeproc{ref-bulbulia2023c}{2023c}), and \(\S 3.1.6\)
...
\includegraphics[width=1\textwidth,height=\textheight]{v2-short-causal-diagrams_files/figure-pdf/fig-dag-1-1.pdf}
