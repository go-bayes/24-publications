...
For *friends gives money*, the effect estimate is 1.137 [0.964, 1.342]. The E-value for this estimate is 1.532, with a lower bound of 1. At this lower bound, unmeasured confounders would need a minimum association strength with both the intervention sequence and outcome of 1 to negate the observed effect. Weaker confounding would not overturn it. We infer *that evidence for causality is not reliable*.
...
For *friends gives money*, the effect estimate is 1.041 [0.951, 1.139]. The E-value for this estimate is 1.248, with a lower bound of 1. At this lower bound, unmeasured confounders would need a minimum association strength with both the intervention sequence and outcome of 1 to negate the observed effect. Weaker confounding would not overturn it. We infer *that evidence for causality is not reliable*.
...
However, it is important to emphasise that these population-wide estimates for aggregated one-year effects reflect short-term behavioural changes and do not address the broader, longer-term implications of gaining or losing religious institutions — an issue we revisit in the discussion.
...
Finally, the generalisability of our findings beyond New Zealand remains to be investigtated. Although our results apply to the New Zealand population, further research is needed to determine whether these findings hold in other cultural or national contexts. Initiatives such as the Global Flourish Study [@johnson2022global], and others, will eventually provide opportunities to apply causal methods across diverse cultures.

In conclusion, by integrating robust causal methods with longitudinal panel data, we provide clear quantitative evidence that religious service attendance causally affects prosocial behaviours. Beyond the significance of these findings, we hope this study encourages psychological scientists to adopt causal methods, which remain underutilised in the discipline. Most psychological questions are inherently causal. To understand the effects of interventions, something beyond the associational methods that dominate observational psychology is required [@bulbulia2024swigstime;@vanderweele2021can; @rohrer2022PATH].
