...
Bulbulia, JosephA (2024c) Methods in causal inference part 1: Causal
diagrams and confounding. \emph{Evolutionary Human Sciences},
\textbf{6}.

\bibitem[\citeproctext]{ref-bulbulia2024swigstime}
Bulbulia, JosephA (2024d) Methods in causal inference part 2:
...
This appendix provides an explanation for the observed difference in
marginal effects between censored and uncensored populations in the
study.
