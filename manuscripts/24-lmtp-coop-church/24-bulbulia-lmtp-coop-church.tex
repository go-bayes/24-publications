...
\item
  ...
  attendance yields \textbf{an individual average donation rate of NZD
  1638.98.}
\item
  \textbf{Zero Religious Service}: Reducing religious service attendance
  to zero yields \textbf{an average donation rate of NZD 984.59.}
\item
  \textbf{Status Quo}: the expected individual \textbf{average donation
  rate is currently NZD 1037.14.}
\end{itemize}
...
compared to non-attendance. Notice that just as our measures of
prosocial actions (charity/volunteering) do not capture the targets of
prosocial help, likewise our measures of community help received
(time/money) do not capture the specific sources of help beyond the
categories of ``community,'' ``freinds,'' and ``family''. Nevertheless,
the evolutionary theories of religious prosociality that motivate this
study are grounded on within group-cooperative benefits
...
Because we assume investigators seek both scientific knowledge and
...
(refer to VanderWeele (\citeproc{ref-vanderweele2015}{2015}))
...
We hope this research will serve as a guide for studies investigating
the social consequences of religious behaviour in other countries.

However, much remains to be discovered about the mechanisms by which
religious service attendance affects social behaviours, even within New
Zealand. Here, we have raised a series of \emph{how much?} questions
about the influence of religious service on charity and volunteering. We
do not attempt to elucidate the pathways by which such effects operate;
nor do we describe their heterogeneity. A substantial body of research
has examined the psychological and cultural features through which
religious behaviours affect individuals
...
\emph{et al.} 2016}). Yet obtaining a data-driven causal understanding
about the pathways through which these features operate presents both
...
challenges are underappreciated (refer to Bulbulia
(\citeproc{ref-bulbulia2023}{2023})). However, by carefully navigating
...
inferential methods over multiple repeated waves to address questions of
