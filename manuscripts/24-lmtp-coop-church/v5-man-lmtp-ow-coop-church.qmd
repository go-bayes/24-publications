...
abstract: |
 We use large-scale national panel data to quantitatively estimate the causal relationship between religion and prosociality within the New Zealand population. We define three causal contrasts for attendance: 1) weekly versus none; 2) weekly versus observed rates 3) no attendance versus observed rates. We measure prosociality is through volunteering hours, charitable donations, perceived social connections, and received personal and financial help. Reported help measures are designed to minimise self-presentation bias. Effects were calculated on difference scales for continuous/ordinal outcomes and risk-ratio scales for binary outcomes. Results indicate a prosocial benefit across most measures, though the extent and quality of benefits vary by estimand and are generally weaker than those suggested by cross-sectional associations. Nevertheless, quantify the economic benefits of religious service reveals considerable economic value. Our approach offers a robust method for quantitatively assessing the causal effects of religious behaviors using observational data.
author: 
...
Let $Y(\bar{a})$ denote a potential outcome under the treatment rule $f(A)$; Let $L$ denote the set of measured covariates we assume to be sufficient for confounding control.
