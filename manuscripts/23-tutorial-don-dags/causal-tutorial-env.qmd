...
4. **Analysis and Comparison**: the analysis compares the estimated effects of $A$ on $Y$ under both model specifications.

5. **Presentation**: the results are displayed in a comparative table.
