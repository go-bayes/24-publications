...
(\citeproc{ref-hernuxe1n2004a}{Hernán \emph{et al.} 2004}). In most
...
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Truth} & \multicolumn{2}{c}{Standard} & \multicolumn{2}{c}{Control: Baseline Outcome} & \multicolumn{2}{c}{Control: Baseline Exposure} & \multicolumn{2}{c}{Control: Baseline Exposure/Outcome} \\
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5} \cmidrule(l{3pt}r{3pt}){6-7} \cmidrule(l{3pt}r{3pt}){8-9} \cmidrule(l{3pt}r{3pt}){10-11}
\textbf{Characteristic} & \textbf{Beta} & \textbf{95\% CI} & \textbf{Beta} & \textbf{95\% CI} & \textbf{Beta} & \textbf{95\% CI} & \textbf{Beta} & \textbf{95\% CI} & \textbf{Beta} & \textbf{95\% CI}\\
\midrule
\textbf{A\_1} & 0.30 & 0.30, 0.30 & 0.91 & 0.75, 1.1 & 0.35 & 0.29, 0.41 & 0.80 & 0.66, 0.93 & 0.31 & 0.31, 0.32\\
\bottomrule
\multicolumn{11}{l}{\rule{0pt}{1em}\textsuperscript{1} CI = Confidence Interval}\\
\end{tabular}}
\end{table}
