...
table_religion_kbl <- here_read("table_religion_kbl")
table_religion <- here_read("table_religion")
table_demographics <- here_read("table_demographics")
table_demographics_kbl <- here_read("table_demographics_kbl")
table_wellbeing_kbl <- here_read("table_wellbeing_kbl")
...
Demographic data are presented in @tab-demography
