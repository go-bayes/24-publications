...
Whether considering interaction as effect modification or as a double intervention, we must state a scale at which we indent to measure our contrasts. This is because evidence of effect-modification or interaction that is present at one scale may not be present at another. Here, we will restrict our examples to causal contrasts on the additive scale.  

The key point here is that before writing applying statistical models to data, we 
