...
\hypersetup{
  pdftitle={Supplementary files for ``Methods in Causal Inference Part 3: Measurement Error and External Validity Threats''},
...
\title{Supplementary files for ``Methods in Causal Inference Part 3:
Measurement Error and External Validity Threats''}
...
Here, \(\widehat{ATE}_S\) is the estimated average treatment effect from
the source population, and \(R\) represents the set of covariates used
for adjustment.
