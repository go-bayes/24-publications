...
abstract: |
  The question of whether religion causes prosociality is poorly defined. To make this question precise we must to state the causal contrasts of interest, specific measures of "prosociality," and the target population for whom results generalise. Here we investigate the one-year effect of three hypothetical interventions on religious service attendance across the New Zealand population. The causal contrasts are: (1) weekly (or more) religious service attendance vs zero attendance, which addresses the question "what would be the difference if everyone attended weekly religious service compared with no-one attending?"; (2) weekly (or more) religious service attendance vs the observed attenendance rate, which addresses the question: "what would difference would it make to the measured prosociality outcomes if everyone in the country switched to weekly religious service if they were not attending already?" (3) zero religious service attendance vs the observed attenendance rate, which addresses the question: "what would be the difference if religious service attendance were to disappear altogther?" Because "prosociality" is ill-defined we must describe our measures. Here,  we evaluate (1) **self-reported weekly volunteering**; (2) **self-reported annual charitable donations**; (3) **three available measures of perceived social connection** (social belonging, social support, neighbourhood belonging) (4) **three available measures of reported voluntary help received from others** (from family, friends,and people in the community); (5) **three available measures of reported financial help received from others** (from family, friends, and people in the community). The measures of help-recieved avoid self-presentation bias. Overall we find evidence in most domains for prosocial benefit, however, the quality and magnitude of benefit varies depending on the causal contrast of interest, and is generally much weaker than might be inferred from ill-defined parametric models. Nevertheless, religious service has economic considerable economic benefits. These findings illustrate a pathway for more rigourous investigations for the causal effects of religious behaviours. 
author: 
