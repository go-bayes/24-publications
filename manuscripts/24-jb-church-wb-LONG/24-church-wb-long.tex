...
2020}), debates over causality persist
...
outcomes developed in (\citeproc{ref-pedro_2024effects}{Rosa \emph{et
al.} 2024}). Table 1 summarises each domain and its associated measures.
...
(\citeproc{ref-williams2021}{Williams and Díaz 2021}). This approach
employs sequentially doubly robust (SDR) estimators, as developed by
Díaz \emph{et al.} (\citeproc{ref-diaz2021_non_parametric_lmtp}{2021a})
...
(\citeproc{ref-duxedaz2021}{Díaz \emph{et al.} 2021b}). In the second
...
(\citeproc{ref-margot2024}{Bulbulia 2024a}). For further details of the
...
(\citeproc{ref-reddish2013let}{Reddish \emph{et al.} 2013}). Why
...
sexual satisfaction (\citeproc{ref-dew2020joint}{Dew \emph{et al.}
2020}). Although these studies do reliably estimate causal magnitudes,
