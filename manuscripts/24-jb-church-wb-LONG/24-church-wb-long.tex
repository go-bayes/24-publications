...
\hypersetup{
  pdftitle={National Longitudinal Data Reveal Causal Effects of Religious Service Attendance on Meaning and Purpose, Gratitude, and Sexual Satisfaction (but not much else)},
  pdfauthor={Joseph A. Bulbulia; Chris G. Sibley; Don E Davis; Kenneth G. Rice; Geoffrey Troughton; Daryl Van Tongeren},
  pdfkeywords={Use, use},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\title{National Longitudinal Data Reveal Causal Effects of Religious
Service Attendance on Meaning and Purpose, Gratitude, and Sexual
Satisfaction (but not much else)}
...
multi-dimensional well-being using longitudinal data from a nationally
representative cohort of 46,377'' New Zealanders collected between 2018
and 2023.

\textbf{KEYWORDS}: \emph{Causal Inference}; \emph{Charity};
\emph{Church}; \emph{Cross-validation}; \emph{Distress}; \emph{Health};
...
We control for a rich set of confounders measured at baseline. These are
described in XXXX. We also adjust for physical disability, employment
...
(\citeproc{ref-bulbulia2023}{Bulbulia 2024c};
...
combines predictions from these models. Garphs, tables and output
...
JB did the analysis and developed the approach. CGS led data collection.
JB, DD, CGS, KR, at GT obtained funding. \textbf{All authors had input
into the manuscript.}

\newpage{}

\subsection{Appendix A: Sample Demographic Statistics and Confouding
Control}\label{appendix-measures}

\newpage{}

\subsection{Appendix B: Sample Demographic Statistics and Confouding
Control}\label{appendix-baseline}

Table~\ref{tbl-baseline} presents sample statics information. All
indicators in this table, as well as indicators for the baseline
measurement of the Monthly Religious Service and all outcome variables,
were included for confounding control.
...
\subsection{Appendix B: Exposure Variable}\label{appendix-exposure}
...
\subsubsection{C Baseline Outcome Variables}\label{appendix-outcomes}

\paragraph{Health}\label{health-1}
...
\subsection{D New Zealand Attitudes and Values Study Data Collection
(2018 retained cohort)}\label{appendix-daily}
...
\subsection{Appendix E Transition Matrix to Verify Positivity
