...
\citeproc{ref-tripepi2007}{Tripepi et al., 2007}) and to evaluating
...
\item
  ...
  (\citeproc{ref-suzuki2020}{Suzuki et al., 2020}). A time-indexed node
...
\citeproc{ref-pearl2009a}{2009}). This means that, based on assumptions
...
the rules of d-separation (\citeproc{ref-pearl1995}{Pearl, 1995}), and
...
et al., 2010}). Imagine the same experiment as in Example 1 and the same
...
(\citeproc{ref-lash2009applying}{Lash et al., 2009}). Additional
...
result (refer to Linden et al. (\citeproc{ref-linden2020EVALUE}{2020})
...
(\citeproc{ref-hernan2024WHATIF}{2024}); Dı́az et al.
(\citeproc{ref-diaz2021nonparametric}{2021}); Hoffman et al.
...
sciences (\citeproc{ref-bulbulia2024swigstime}{Bulbulia, 2024a}).
...
to Hernán et al. (\citeproc{ref-hernan2017per}{2017})). These special
...
Bulbulia (\citeproc{ref-bulbulia2024wierd}{2024b})). However, I hope the
...
\citeproc{ref-richardson2013}{Richardson \& Robins, 2013};
\citeproc{ref-young2014identification}{Young et al., 2014}). Special
estimators such as `g-methods' (\citeproc{ref-hernan2024WHATIF}{Hernan
\& Robins, 2024}) or targeted learning
(\citeproc{ref-vanderlaan2018}{Van Der Laan \& Rose, 2018}) may be
...
(\citeproc{ref-hernan2024WHATIF}{Hernan \& Robins, 2024}). My aim has
...
et al., 2022}). This approach might have attenuated effect modification
